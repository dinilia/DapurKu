...
import com.andiniaulia3119.mobpro1.network.UserDataStore
                    ...
                    item {
                        if (showHapusDialog) {
                            HapusDialog(data = recipeData!!, onDismissRequest = { showHapusDialog = false }) {
                                viewModel.deleteData(user.email, recipeData!!.recipeId, recipeData!!.deleteHash)
